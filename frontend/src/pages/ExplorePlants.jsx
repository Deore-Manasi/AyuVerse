...
const ExplorePlants = () => {
  ...
  const filteredPlants = useMemo(() => {
    return plants.filter((plant) => {
      ...
      const matchesFilter =
        selectedFilter === "All" ||
        (plant.categories && plant.categories.includes(selectedFilter));
  ...
  if (loading) {
    return <div className="explore-plants">Loading plants...</div>;
  }
        ...
        >
          {filteredPlants.map((plant, index) => (
            <PlantCard
              ...
              plant={{
                id: plant._id,
                name: plant.plantName, // ✅ mapped
                family: plant.family,
                genus: plant.genus,
                size: plant.size,
                image: plant.image,
                slug: plant.plantName.toLowerCase().replace(/\s+/g, "-"),
              }}
              index={index}
            />
          ))}
